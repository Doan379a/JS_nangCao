...
//   <td>${item.image}</td>
//   <td>
//   <button class="btnedit" data-id="${item.id}">sua</button>
//   <button class="btnxoa" data-id="${item.id}">xoa</button>
//   </td>
//   </tr>`
//       )
//       .join("");
...
//                   alert("ban ko nhap dung du lieu");
//                   return;
//                 }
//                 fetch(`${url}/${id}`, {
//                   method: "PUT",
...
//     if (!proname || !proname || isNaN(progia)) {
...
//       } else {
//         alert("ban nhap sai tai khoan hoac mat ");
//       }
//     });
// });
